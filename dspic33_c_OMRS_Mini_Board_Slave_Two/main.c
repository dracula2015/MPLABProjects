...
{     
    ...
    while(1)
    {
		...
		if(canRxMessage[1].buffer_status==CAN_BUF_FULL)
		{
            ...
            controlEffect = canRxMessage[1].data[0];
            controlEffect = (controlEffect<<8) + canRxMessage[1].data[1];
            controlEffect = (controlEffect<<8) + canRxMessage[1].data[2];
            controlEffect = (controlEffect<<8) + canRxMessage[1].data[3];
